...
#LLVM_PREFIX=/usr
LLVM_PREFIX=/home/markus/src/install-3.5

# Helps Duet find its way
export LD_LIBRARY_PATH=/home/markus/src/apron/install/lib/:/home/markus/src/z3/install/lib/

# Location of WorklistAI .so file (debug)
#WORKLIST_SO=/home/markus/src/LLVMApron/debug/worklist-ai/libworklistAI.so
WORKLIST_SO=/home/markus/src/LLVMApron/release/worklist-ai/libworklistAI.so

# Location of optimized SO
#WORKLIST_OPT_SO=/home/markus/src/LLVMApron/release/worklist-ai/libworklistAI.so

# Location of PDG creation .so file
DYN_PDG_SO=/home/markus/src/LLVMDatalog/build/ContextInsenDynPDG/libDatalogDynCIPDG.so

# Location of Z3 binary
Z3_BIN=/home/markus/src/z3/install/bin/z3
